/*
 * $Id: DiameterCEA.java 2 2006-11-14 22:37:20Z vingarzan $
 *
 ...
 *
 */
public class DiameterCEA extends DiameterMessage {
	...
	public DiameterCEA(int result_code)
	{
		super(DiameterMessage.Code_CE,false,0);
		AVP avp;
