package net.x_talker.log.appender;
...
/**
   CustomDailyRollingFileAppender extends {@link FileAppender} so that the
   underlying file is rolled over at a user chosen frequency.
   
   CustomDailyRollingFileAppender has been observed to exhibit 
...
public class CustomDailyRollingFileAppender extends FileAppender {
  ...
  */
  ...
  /**
    Instantiate a <code>CustomDailyRollingFileAppender</code> and open the
  ...
  */
  ...
  /**
   * This method differentiates CustomDailyRollingFileAppender from its
   * super class.
   *
...
/**
 *  RollingCalendar is a helper class to CustomDailyRollingFileAppender.
