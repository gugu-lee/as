...
//    private SIPResponse pendingReliableResponse;
    ...
    protected void sendResponse(SIPResponse transactionResponse) throws IOException {
    	...
    	logger.logInfo("SIPServerTransaction sendresponse");
        try {
            ...
            if (isReliable()) {
                ...
                logger.logInfo(messageChannel.getClass().getName());
...
//                topViaHeader = (Via) viaHeaders.getFirst();
    ...
    public void sendMessage(SIPMessage messageToSend) throws IOException {
        ...
        logger.logInfo("SIPServerTransaction sendMessage");
        ...
        try {        	        	
            ...
            if(!checkStateTimers(statusCode)) {
            	...
            	logger.logInfo("checkStateTimers returned false -- not sending message");
            	return;
            }
